...
To publish the formula to `ixxq/homebrew-tap`, set the `HOMEBREW_TAP_TOKEN` GitHub Actions secret in `ixxq/awsctx`. The token must be allowed to push to `ixxq/homebrew-tap`.
